...
<div id="content">
	...
	<div id="slider">
	    ...
	    <ul class="slides">
	    	<li><img src="${path}style/images/art/slide1.jpg" alt=""/></li>
	    	<li><img src="${path}style/images/art/slide2.jpg" alt=""/></li>
	    	<li><img src="${path}style/images/art/slide3.jpg" alt=""/></li>
	    	<li><img src="${path}style/images/art/slide4.jpg" alt=""/></li>
	    </ul>
	  </div>
